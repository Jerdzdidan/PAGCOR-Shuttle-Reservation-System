...
class VehicleController extends Controller
{
    ...
    public function index(): Response
    {
        return Inertia::render('admin/vehicles', [
            'vehicles' => Vehicle::query()
                ...
                ->get(['id', 'plate_number', 'vehicle_type', 'capacity', 'status', 'notes']),
        ]);
    }
    ...
    public function destroy(Vehicle $vehicle): RedirectResponse
    {
        if ($vehicle->schedules()->exists()) {
            throw ValidationException::withMessages(['vehicle' => 'This vehicle cannot be deleted because it is referenced by a schedule.']);
        }
